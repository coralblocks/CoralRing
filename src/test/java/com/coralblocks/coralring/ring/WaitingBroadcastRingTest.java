...
public class WaitingBroadcastRingTest {
	...
	public void testFindingCapacity() {
		...
		final RingConsumer<Message> ringConsumer1 = new WaitingBroadcastRingConsumer<Message>(-1, Message.getMaxSize(), Message.class, filename, 1, 3);
		final RingConsumer<Message> ringConsumer2 = new WaitingBroadcastRingConsumer<Message>(-1, Message.getMaxSize(), Message.class, filename, 2, 3);
	...
	public void testFindingNumberOfConsumers() {
		...
		final RingProducer<Message> ringProducer = new WaitingBroadcastRingProducer<Message>(64, Message.getMaxSize(), Message.class, filename, numberOfConsumers);
		final WaitingBroadcastRingConsumer<Message> ringConsumer0 = new WaitingBroadcastRingConsumer<Message>(64, Message.getMaxSize(), Message.class, filename, 0, -1);
		final WaitingBroadcastRingConsumer<Message> ringConsumer1 = new WaitingBroadcastRingConsumer<Message>(64, Message.getMaxSize(), Message.class, filename, 1, -1);
		final WaitingBroadcastRingConsumer<Message> ringConsumer2 = new WaitingBroadcastRingConsumer<Message>(64, Message.getMaxSize(), Message.class, filename, 2, -1);
