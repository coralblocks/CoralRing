...
/**
 * <p>
 * The implementation of a waiting broadcast {@link RingConsumer}. It can wait if the ring becomes empty, in other words, if the producer
 ...
 */
public class WaitingBroadcastRingConsumer<E extends MemorySerializable> implements RingConsumer<E> {
	
	private static final int DEFAULT_CAPACITY = WaitingBroadcastRingProducer.DEFAULT_CAPACITY;
	
	private static final int SEQ_PREFIX_PADDING = WaitingBroadcastRingProducer.SEQ_PREFIX_PADDING;

	private static final int CPU_CACHE_LINE = WaitingBroadcastRingProducer.CPU_CACHE_LINE;
	 ...
	 * @param numberOfConsumers the total number of consumers (including this one)
	 */
	public WaitingBroadcastRingConsumer(int capacity, int maxObjectSize, Class<E> klass, String filename, int consumerIndex, int numberOfConsumers) {
	 ...
	 * @param numberOfConsumers the total number of consumers (including this one)
	 */
	public WaitingBroadcastRingConsumer(int maxObjectSize, Builder<E> builder, String filename, int consumerIndex, int numberOfConsumers) {
	 ...
	 * @param numberOfConsumers the total number of consumers (including this one)
	 */
	public WaitingBroadcastRingConsumer(int maxObjectSize, Class<E> klass, String filename, int consumerIndex, int numberOfConsumers) {
