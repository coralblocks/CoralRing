	...
	public static void main(String[] args) {
		...
		{ 
			...
			for(int i = 0; i < bb.capacity(); i++) {
				byte b = (byte) String.valueOf(i % 10).charAt(0);	 // creates garbage!
				bb.put(b);
			}
			bb.flip();
			...
			System.out.println("Hash 32 => " + hash32(bb, SEED));
			System.out.println("Hash 64 => " + hash64(bb, SEED));
		}
		...
		{ 
			...
			// change a single byte to see the difference:
			bb.put(1000, (byte) 'X');
