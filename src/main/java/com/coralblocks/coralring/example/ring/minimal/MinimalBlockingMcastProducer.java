...
public class MinimalBlockingMcastProducer {
	
	final static String FILENAME = "minimal-blocking-mcast.mmap";
	...
	public static void main(String[] args) {
		...
		final RingProducer<MutableLong> ringProducer = new BlockingMcastRingProducer<MutableLong>(8, MutableLong.getMaxSize(), 
