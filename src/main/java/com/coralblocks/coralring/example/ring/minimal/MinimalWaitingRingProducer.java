...
public class MinimalWaitingRingProducer {
	...
	public static void main(String[] args) {
		...
		final RingProducer<MutableLong> ringProducer = new WaitingRingProducer<MutableLong>(MutableLong.getMaxSize(), MutableLong.class, FILENAME); // default size is 1024
