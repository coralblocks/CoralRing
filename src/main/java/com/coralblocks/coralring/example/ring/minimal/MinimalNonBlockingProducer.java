...
public class MinimalNonBlockingProducer {
	...
	public static void main(String[] args) {
		...
		final RingProducer<MutableLong> ringProducer = new NonBlockingRingProducer<MutableLong>(MutableLong.getMaxSize(), MutableLong.class, FILENAME); // default size is 1024
