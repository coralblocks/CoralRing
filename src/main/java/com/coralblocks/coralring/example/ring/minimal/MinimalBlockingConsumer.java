...
public class MinimalBlockingConsumer {
	...
	public static void main(String[] args) {
		...
		final RingConsumer<MutableLong> ringConsumer = new BlockingRingConsumer<MutableLong>(MutableLong.getMaxSize(), MutableLong.class, FILENAME); // default size is 1024
