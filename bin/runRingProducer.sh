...
CMD="java $ADD_OPENS -cp target/classes:target/coralring-all.jar com.coralblocks.coralring.example.ring.Producer $MESSAGES_TO_SEND $BATCH_SIZE_TO_SEND $SLEEP_TIME"
