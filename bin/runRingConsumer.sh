...
CMD="java $ADD_OPENS -cp target/classes:target/coralring-all.jar com.coralblocks.coralring.example.ring.BlockingConsumer $EXPECTED_MESSAGES_TO_RECEIVE $SLEEP_TIME"
